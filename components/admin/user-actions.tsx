    ...
    <>
      <div className="sg-admin-action-stack">
        ...
        <button
          type="button"
          disabled={self}
          className="sg-button sg-button-danger sg-button-sm"
          onClick={() =>
            setAction(
              "delete",
            )
      ...
      {message && (
        <p
          role="status"
          className="sg-inline-notice mt-4"
        >
          {message}
        </p>
      )}
      ...
      {action && (
        ...
        >
          <div
            className={`sg-admin-confirm-dialog${
              action ===
              "delete"
                ? " sg-admin-confirm-dialog-danger"
                : ""
            }`}
          >
            {action ===
              "delete" && (
              <span
                className="sg-admin-confirm-icon"
                aria-hidden="true"
              >
                <AlertTriangle
                  size={18}
            ...
            {action ===
              ...
              <>
                ...
                <div
                  ...
                  aria-label="Platform access options"
                >
                  <button
                    type="button"
                    disabled={
                    ...
                    className="rounded-lg border border-surface-edge bg-surface-raised px-3 py-2.5 text-left transition-colors hover:border-sky-400/40 hover:bg-surface disabled:cursor-not-allowed disabled:opacity-45"
                    onClick={() =>
                      execute(() =>
                        changePlatformRoleAction(
                          userId,
            ...
            {action ===
              "delete" && (
              <div className="sg-admin-delete-confirmation">
                <p>
                  This action
                  permanently
                  deletes{" "}
